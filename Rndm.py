...
def o():
    ...
    print("  ║ \033[97;1m[\033[38;5;46m3\033[97;1m] \033[97;1mJOIN MY WhatsApp Group")
    ...
    if ToxicN == '3':
        os.system('xdg-open https://chat.whatsapp.com/CPuAF4261Jl0VyfKZmtSnk')
    if ToxicN == 'E':
        os.system('exit')
        return None
...
def i():
    ...
    with ThreadPool(max_workers=50) as setu:
        ...
        print("  ╚\033[0m═══════════════════════════════════════════════════╝ ")
        for toxic in user:
            pwx = [toxic,'###@@@','@@@###','123@@@','123###','bangladesh','i love you','Bangladesh','free fire','Free fire','I love you','112244','09876543','00009999',]
            uid = code+toxic
...
def Subscraption():
	key1=open('/storage/emulated/0/android8.txt', 'r').read()
	r1=requests.get("https://github.com/Mrvenom01/Approval/blob/main/Approval.txt").text
	if key1 in r1:
		os.system('clear')
		o()
	else:
		...
		os.system('am start https://wa.me/+8801946063621?text=' + tks)
		Subscraption() 
#Subscraption()
o()
